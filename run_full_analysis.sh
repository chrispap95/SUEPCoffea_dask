...
if [ $signal -eq 1 ]; then
    ...
    python runner.py \
        ...
        --json filelists/signal/GluGluToSUEP_central_UL18_Nov2024.json --era 2018 --do_syst \
    ...
    python runner.py \
        ...
        --json filelists/signal/GluGluToSUEP_central_UL18_Nov2024.json --era 2018 --do_syst \
        --executor dask/lpc --chunk 3000 --skimmed --trigger TripleMu --isMC
...
if [ $data -eq 1 ]; then
    if [ $blind -eq 0 ]; then
        ...
        python runner.py \
            ...
            --executor futures -j 8 --chunk 50000 --trigger TripleMu --era 2018
    ...
    python runner.py \
        ...
        --executor futures -j 8 --chunk 50000 --trigger TripleMu --isMC
fi
