...
secondary_dataset = (
    "RunIISummer19UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1+MINIAODSIM/"
)
...
skim = dak.to_parquet(
    muons,
    "/uscms_data/d3/chpapage/SUEPs/MuonTriggers/muon_branches/SUEPCoffea_dask/test.parquet",
)
