...
class SUEP_processor(SUEP_common.SUEP_base):
    ...
    def apply_VR(self, events):
        ...
        # Find dimuon pairs and apply resonance vetoes
        ...
        if len(muon_pairs_0):
            ...
            # NOTE: This is effective in removing signal contamination,
            # but makes the data/MC shape look very off.
            # alt_sig_mask = (
        ...
        #     (abs(muons.ip3d) > 0.01) & (muons.miniPFRelIso_all > 0.2)
        # ]
        muons_VR_loose = muons[
        ...
        #     (abs(muons.ip3d) > 0.02) & (muons.miniPFRelIso_all > 0.4)
        # ]
        muons_VR_tight = muons[
