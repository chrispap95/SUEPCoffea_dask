...
class SUEP_processor(SUEP_common.SUEP_base):
    ...
    def fill_histograms(self, events, output):
        ...
        muons1 = muons_CR_prompt[muons_CR_prompt.charge == 1]
        muons2 = muons_CR_prompt[muons_CR_prompt.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_CR_prompt = muons_CR_prompt[enough_muons]
        events_CR_prompt = events_CR_prompt[enough_muons]
        ...
        if len(events_CR_prompt) > 0:
            ...
            output[dataset]["histograms"]["CR_prompt_dimuon_mass"].fill(
                ak.flatten(dimuon_masses),
                ak.flatten(ak.broadcast_arrays(nMuon_CR_prompt, dimuon_masses)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(weights_CR_prompt.weight(), dimuon_masses)[0]
                ),
            )

        events_CR_cb, muons_CR_cb = self.apply_CR_cb(events_)
        muons1 = muons_CR_cb[muons_CR_cb.charge == 1]
        muons2 = muons_CR_cb[muons_CR_cb.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_CR_cb = muons_CR_cb[enough_muons]
        events_CR_cb = events_CR_cb[enough_muons]
        muon_pairs = ak.unzip(ak.cartesian([muons1, muons2]))
        muon_pairs_0 = muon_pairs[0]  # type: ignore[index]
        muon_pairs_1 = muon_pairs[1]  # type: ignore[index]
        dimuon_masses = (muon_pairs_0 + muon_pairs_1).mass
        if len(events_CR_cb) > 0:
            ...
            output[dataset]["histograms"]["CR_cb_dimuon_mass"].fill(
                ak.flatten(dimuon_masses),
                ak.flatten(ak.broadcast_arrays(nMuon_CR_cb, dimuon_masses)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(weights_CR_cb.weight(), dimuon_masses)[0]
                ),
            )
        ...
        muons1 = muons_SR_high_temp_tight[muons_SR_high_temp_tight.charge == 1]
        muons2 = muons_SR_high_temp_tight[muons_SR_high_temp_tight.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_SR_high_temp_tight = muons_SR_high_temp_tight[enough_muons]
        events_SR_high_temp_tight = events_SR_high_temp_tight[enough_muons]
        muon_pairs = ak.unzip(ak.cartesian([muons1, muons2]))
        muon_pairs_0 = muon_pairs[0]  # type: ignore[index]
        muon_pairs_1 = muon_pairs[1]  # type: ignore[index]
        dimuon_masses_tight = (muon_pairs_0 + muon_pairs_1).mass
        if len(events_SR_high_temp_tight) > 0:
            ...
            nMuon = ak.num(muons_SR_high_temp_tight)
            nMuon = ak.where(nMuon > 7, 7, nMuon)
            output[dataset]["histograms"]["SR_high_temp_tight_dimuon_mass"].fill(
                ak.flatten(dimuon_masses_tight),
                ak.flatten(ak.broadcast_arrays(nMuon, dimuon_masses_tight)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(
                        weights_SR_high_temp_tight.weight(), dimuon_masses_tight
                    )[0]
                ),
            )

        muons1 = muons_SR_high_temp_loose[muons_SR_high_temp_loose.charge == 1]
        muons2 = muons_SR_high_temp_loose[muons_SR_high_temp_loose.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_SR_high_temp_loose = muons_SR_high_temp_loose[enough_muons]
        events_SR_high_temp_loose = events_SR_high_temp_loose[enough_muons]
        muon_pairs = ak.unzip(ak.cartesian([muons1, muons2]))
        muon_pairs_0 = muon_pairs[0]  # type: ignore[index]
        muon_pairs_1 = muon_pairs[1]  # type: ignore[index]
        dimuon_masses_loose = (muon_pairs_0 + muon_pairs_1).mass
        if len(events_SR_high_temp_loose) > 0:
            ...
            nMuon = ak.num(muons_SR_high_temp_loose)
            nMuon = ak.where(nMuon > 7, 7, nMuon)
            output[dataset]["histograms"]["SR_high_temp_loose_dimuon_mass"].fill(
                ak.flatten(dimuon_masses_loose),
                ak.flatten(ak.broadcast_arrays(nMuon, dimuon_masses_loose)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(
                        weights_SR_high_temp_loose.weight(), dimuon_masses_loose
                    )[0]
                ),
            )
        ...
        muons1 = muons_SR_low_temp_tight[muons_SR_low_temp_tight.charge == 1]
        muons2 = muons_SR_low_temp_tight[muons_SR_low_temp_tight.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_SR_low_temp_tight = muons_SR_low_temp_tight[enough_muons]
        events_SR_low_temp_tight = events_SR_low_temp_tight[enough_muons]
        muon_pairs = ak.unzip(ak.cartesian([muons1, muons2]))
        muon_pairs_0 = muon_pairs[0]  # type: ignore[index]
        muon_pairs_1 = muon_pairs[1]  # type: ignore[index]
        dimuon_masses_tight = (muon_pairs_0 + muon_pairs_1).mass
        if len(events_SR_low_temp_tight) > 0:
            ...
            nMuon = ak.num(muons_SR_low_temp_tight)
            nMuon = ak.where(nMuon > 7, 7, nMuon)
            output[dataset]["histograms"]["SR_low_temp_tight_dimuon_mass"].fill(
                ak.flatten(dimuon_masses_tight),
                ak.flatten(ak.broadcast_arrays(nMuon, dimuon_masses_tight)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(
                        weights_SR_low_temp_tight.weight(), dimuon_masses_tight
                    )[0]
                ),
            )

        muons1 = muons_SR_low_temp_loose[muons_SR_low_temp_loose.charge == 1]
        muons2 = muons_SR_low_temp_loose[muons_SR_low_temp_loose.charge == -1]
        enough_muons = (ak.num(muons1) > 0) & (ak.num(muons2) > 0)
        muons1 = muons1[enough_muons]
        muons2 = muons2[enough_muons]
        muons_SR_low_temp_loose = muons_SR_low_temp_loose[enough_muons]
        events_SR_low_temp_loose = events_SR_low_temp_loose[enough_muons]
        muon_pairs = ak.unzip(ak.cartesian([muons1, muons2]))
        muon_pairs_0 = muon_pairs[0]  # type: ignore[index]
        muon_pairs_1 = muon_pairs[1]  # type: ignore[index]
        dimuon_masses_loose = (muon_pairs_0 + muon_pairs_1).mass
        if len(events_SR_low_temp_loose) > 0:
            ...
            nMuon = ak.num(muons_SR_low_temp_loose)
            nMuon = ak.where(nMuon > 7, 7, nMuon)
            output[dataset]["histograms"]["SR_low_temp_loose_dimuon_mass"].fill(
                ak.flatten(dimuon_masses_loose),
                ak.flatten(ak.broadcast_arrays(nMuon, dimuon_masses_loose)[0]),
                weight=ak.flatten(
                    ak.broadcast_arrays(
                        weights_SR_low_temp_loose.weight(), dimuon_masses_loose
                    )[0]
                ),
            )
    ...
    def process(self, events):
        ...
        histograms = {
            "CR_prompt_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="CR_prompt_dimuon_mass",
                label="CR_prompt_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(4, 2, 6, name="nMuon", label="nMuon")
            .Weight(),
            "CR_cb_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="CR_cb_dimuon_mass",
                label="CR_cb_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(4, 1, 5, name="nMuon", label="nMuon")
            .Weight(),
            "SR_high_temp_tight_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="SR_high_temp_tight_dimuon_mass",
                label="SR_high_temp_tight_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(5, 3, 8, name="nMuon", label="nMuon")
            .Weight(),
            "SR_high_temp_loose_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="SR_high_temp_loose_dimuon_mass",
                label="SR_high_temp_loose_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(5, 3, 8, name="nMuon", label="nMuon")
            .Weight(),
            "SR_low_temp_tight_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="SR_low_temp_tight_dimuon_mass",
                label="SR_low_temp_tight_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(5, 3, 8, name="nMuon", label="nMuon")
            .Weight(),
            "SR_low_temp_loose_dimuon_mass": hist.Hist.new.Regular(
                100,
                1e-1,
                2e2,
                name="SR_low_temp_loose_dimuon_mass",
                label="SR_low_temp_loose_dimuon_mass",
                transform=hist.axis.transform.log,
            )
            .Regular(5, 3, 8, name="nMuon", label="nMuon")
            .Weight(),
