...
class SUEP_processor(SUEP_common.SUEP_base):
    ...
    def fill_histograms(self, events, output):
        ...
        if len(events_SR_low_temp_tight) > 0:
            muon_pairs_0, muon_pairs_1 = self.find_dimuon_pairs(muons_SR_low_temp_tight)  # type: ignore[assignment]
            ...
            if len(events_SR_low_temp_tight) > 0:
                weights_SR_low_temp_tight = self.get_weights(
                    events_SR_low_temp_tight, do_vars=False, apply_lumi_factors=True
                )
                if self.isMC:
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_pt"].fill(
                    ak.flatten(muons_SR_low_temp_tight.pt),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight, muons_SR_low_temp_tight.pt
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_eta"].fill(
                    ak.flatten(muons_SR_low_temp_tight.eta),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight, muons_SR_low_temp_tight.eta
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_phi"].fill(
                    ak.flatten(muons_SR_low_temp_tight.phi),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight, muons_SR_low_temp_tight.phi
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_iso"].fill(
                    ak.flatten(muons_SR_low_temp_tight.miniPFRelIso_all),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight,
                            muons_SR_low_temp_tight.miniPFRelIso_all,
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_dxy"].fill(
                    ak.flatten(muons_SR_low_temp_tight.dxy),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight, muons_SR_low_temp_tight.dxy
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_muon_dz"].fill(
                    ak.flatten(muons_SR_low_temp_tight.dz),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_tight, muons_SR_low_temp_tight.dz
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_dimuon_dr"].fill(
                    ak.flatten(muon_pairs_dr),
                    ak.flatten(
                        ak.broadcast_arrays(nMuon_SR_low_temp_tight, muon_pairs_dr)[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_tight.weight(), muon_pairs_dr
                        )[0]
                    ),
                )
                ...
                output[dataset]["histograms"]["SR_low_temp_tight_dimuon_mass"].fill(
                    ...
                    ak.flatten(
                        ak.broadcast_arrays(nMuon_SR_low_temp_tight, muon_pairs_mass)[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_tight.weight(), muon_pairs_mass
                        )[0]
                    ),
                )

        if len(events_SR_low_temp_loose) > 0:
            muon_pairs_0, muon_pairs_1 = self.find_dimuon_pairs(muons_SR_low_temp_loose)  # type: ignore[assignment]
            dimuon_dr_mask = muon_pairs_0.delta_r(muon_pairs_1) < 0.3
            dimuon_mass = (muon_pairs_0 + muon_pairs_1).mass
            dimuon_mass_mask = ((dimuon_mass > 2.7) & (dimuon_mass < 3.5)) | (
                (dimuon_mass > 8.8) & (dimuon_mass < 11.2)
            ...
            if len(events_SR_low_temp_loose) > 0:
                muon_pairs_0, muon_pairs_1 = self.find_dimuon_pairs(  # type: ignore[assignment]
                    muons_SR_low_temp_loose
                )
                weights_SR_low_temp_loose = self.get_weights(
                    events_SR_low_temp_loose, do_vars=False, apply_lumi_factors=True
                )
                if self.isMC:
                ...
                output[dataset]["histograms"]["SR_low_temp_loose_muon_pt"].fill(
                    ak.flatten(muons_SR_low_temp_loose.pt),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose, muons_SR_low_temp_loose.pt
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_loose_muon_eta"].fill(
                    ak.flatten(muons_SR_low_temp_loose.eta),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose, muons_SR_low_temp_loose.eta
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(),
                            muons_SR_low_temp_loose.eta,
                        )[0]
                    ),
                )
                output[dataset]["histograms"]["SR_low_temp_loose_muon_phi"].fill(
                    ak.flatten(muons_SR_low_temp_loose.phi),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose, muons_SR_low_temp_loose.phi
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(),
                            muons_SR_low_temp_loose.phi,
                        )[0]
                    ),
                )
                output[dataset]["histograms"]["SR_low_temp_loose_muon_iso"].fill(
                    ak.flatten(muons_SR_low_temp_loose.miniPFRelIso_all),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose,
                            muons_SR_low_temp_loose.miniPFRelIso_all,
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                ...
                output[dataset]["histograms"]["SR_low_temp_loose_muon_dxy"].fill(
                    ak.flatten(muons_SR_low_temp_loose.dxy),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose, muons_SR_low_temp_loose.dxy
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(),
                            muons_SR_low_temp_loose.dxy,
                        )[0]
                    ),
                )
                output[dataset]["histograms"]["SR_low_temp_loose_muon_dz"].fill(
                    ak.flatten(muons_SR_low_temp_loose.dz),
                    ak.flatten(
                        ak.broadcast_arrays(
                            nMuon_SR_low_temp_loose, muons_SR_low_temp_loose.dz
                        )[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(),
                            muons_SR_low_temp_loose.dz,
                        )[0]
                    ),
                )
                muon_pairs_dr = muon_pairs_0.delta_r(muon_pairs_1)
                output[dataset]["histograms"]["SR_low_temp_loose_dimuon_dr"].fill(
                    ak.flatten(muon_pairs_dr),
                    ak.flatten(
                        ak.broadcast_arrays(nMuon_SR_low_temp_loose, muon_pairs_dr)[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(), muon_pairs_dr
                        )[0]
                    ),
                )
                muon_pairs_mass = (muon_pairs_0 + muon_pairs_1).mass
                output[dataset]["histograms"]["SR_low_temp_loose_dimuon_mass"].fill(
                    ak.flatten(muon_pairs_mass),
                    ak.flatten(
                        ak.broadcast_arrays(nMuon_SR_low_temp_loose, muon_pairs_mass)[0]
                    ),
                    weight=ak.flatten(
                        ak.broadcast_arrays(
                            weights_SR_low_temp_loose.weight(), muon_pairs_mass
                        )[0]
                    ),
                )
