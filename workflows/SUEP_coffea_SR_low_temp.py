...
class SUEP_cluster(processor.ProcessorABC):
    ...
    def fill_histograms(self, events, output):
        ...
        weights_SR_low_temp_tight.add(
            "MuonSF",
            weight=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_tight, syst=""),
                axis=-1,
            ),
            weightUp=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_tight, syst="up"),
                axis=-1,
            ),
            weightDown=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_tight, syst="down"),
                axis=-1,
            ),
        )
        ...
        weights_SR_low_temp_loose.add(
            "MuonSF",
            weight=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_loose, syst=""),
                axis=-1,
            ),
            weightUp=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_loose, syst="up"),
                axis=-1,
            ),
            weightDown=ak.prod(
                muon_sf_utils.muon_scale_factors(muons_SR_low_temp_loose, syst="down"),
                axis=-1,
            ),
        )
